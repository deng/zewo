...
void main() {
  ...
  testWidgets(
    'broadcasts a real eth sepolia transfer with funded wallet',
    (tester) async {
      ...
      await importWalletAndAddEthSepoliaWallet(
        tester,
        walletName: 'ETH Funded',
        mnemonic: config.fundedEthSepoliaMnemonic,
      );
      ...
      expect(
        ...
        config.fundedEthSepoliaAddress.toLowerCase(),
      );
      ...
      await fillEvmTransferForm(
        tester,
        address: config.ethSepoliaTransferRecipientAddress,
        amount: config.ethSepoliaTransferAmount,
      );
    ...
    skip: walletConfig == null || !walletConfig.hasFundedEthSepoliaWallet,
  );
}
