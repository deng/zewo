...
void main() {
  ...
  testWidgets('shows validation error for invalid tron address', (
    tester,
  ) async {
    await launchTestApp();
    ...
    expect(currentWallet!.chainId, trxChainIdForIntegrationNetwork(trxNetwork));

    await openTransferFromWalletHome(tester);
    await expectTrxTransferPage(tester);

    await fillTrxTransferForm(tester, address: 'invalid-address', amount: '1');
